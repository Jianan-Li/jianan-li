...
(function (global, factory) {
  ...
  **/
    ...
    methods: {
      ...
      tickFrame: function tickFrame(state) {
        ...
        function paintLinks() {
          ...
          ctx.save();
          var visibleLinks = state.graphData.links.filter(getVisibility); // Bundle strokes per unique color/width for performance optimization
  ...
  var linkedProps = Object.assign.apply(Object, _toConsumableArray(['nodeColor', 'nodeAutoColorBy', 'nodeCanvasObject', 'linkColor', 'linkAutoColorBy', 'linkWidth', 'linkDirectionalArrowLength', 'linkDirectionalArrowColor', 'linkDirectionalArrowRelPos', 'linkDirectionalParticles', 'linkDirectionalParticleSpeed', 'linkDirectionalParticleWidth', 'linkDirectionalParticleColor', 'dagMode', 'dagLevelDistance', 'd3AlphaDecay', 'd3VelocityDecay', 'warmupTicks', 'cooldownTicks', 'cooldownTime', 'onEngineTick', 'onEngineStop'].map(function (p) {
  ...
  var forceGraph = Kapsule({
    ...
    init: function init(domNode, state) {
      ...
      }, false); // Handle click events on nodes
